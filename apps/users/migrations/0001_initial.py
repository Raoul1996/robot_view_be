    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('mail', 'mail'), ('female', 'female')], default='female', max_length=6, verbose_name='gender')),
                ('mobile', models.CharField(blank=True, help_text='phone', max_length=100, null=True, verbose_name='phone')),
